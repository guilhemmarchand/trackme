...
**The Ops view for Splunk indexing queues is accessible from the "Ops: Indexers queues" button in the main Trackme screen:**
...
- You can choose different break down options in the detailed queue usage treillis charts
