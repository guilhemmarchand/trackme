require([
     ...
     var CustomRangeRenderer = TableView.BaseCellRenderer.extend({
         ...
         render: function($td, cell) {
             var a = $('<div>').attr({"id":"chk-tags-policy"+cell.value,"value":cell.value}).addClass('checkbox').click(function() {
                 ...
                 tokens.set("removeTagsPolicy", selected_values_array.join());
     ...
     //List of table IDs
     var tableIDs = ["tableTagsPolicies"];
